...
const tocData: TOCSection[] = [
  ...
  },
  {
    ...
    page: 1,
    subsections: [
      { id: 'edu-phd', title: 'Ph.D. in Computer Science', page: 1 },
      { id: 'edu-bs', title: 'B.S. in Computer Science', page: 1 },
    ],
  },
  {
    id: 'publications',
    ...
    page: 2,
    subsections: [
      { id: 'pub-1', title: 'WS-GRPO: Weakly-Supervised GRPO...', page: 2 },
      { id: 'pub-2', title: 'MASS-DPO: Multi-negative Active Sample...', page: 2 },
      { id: 'pub-3', title: 'Generate, Filter, Control, Replay...', page: 2 },
      { id: 'pub-4', title: 'A Low-Latency Fraud Detection Layer...', page: 2 },
      { id: 'pub-5', title: 'ECO-GEO: Experimentation-Augmented...', page: 3 },
      { id: 'pub-6', title: 'Towards Agentic Recommender Systems...', page: 3 },
      { id: 'pub-7', title: 'CTRLs: Chain-of-Thought Reasoning...', page: 3 },
      { id: 'pub-8', title: 'Explainable Chain-of-Thought Reasoning...', page: 3 },
      { id: 'pub-9', title: 'Improving Multi-Candidate Speculative...', page: 3 },
    ],
  },
  {
    id: 'experience',
    ...
    page: 4,
    subsections: [
      { id: 'exp-adobe', title: 'Adobe Research', page: 4 },
      { id: 'exp-caltech', title: 'Caltech', page: 4 },
      { id: 'exp-uci', title: 'UC Irvine', page: 4 },
      { id: 'exp-navy', title: 'NIWCP', page: 4 },
      { id: 'exp-usmc', title: 'United States Marine Corps', page: 4 },
    ],
  },
];
